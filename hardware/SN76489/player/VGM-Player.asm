; simple player for vgm files
; The files must be converted into a special format for the minimum
; The format and the converter are from Simon M
; https://github.com/simondotm/vgm-converter
#org 0x2000
    MIB 0xfe,0xffff
	JPS _SkipSpace
	CIT 39,_ReadPtr BLE failure	; no filename specified
	JPS _LoadFile
	CPI 0
	BNE success
failure:
